...
namespace qf_Laser 
{
    public class MarkEzd_ : Language_
    {
        /// <summary>
        /// 打标卡初始化状态
        /// </summary>
        ...
        public virtual _Err_jczMarkEzd2_ 获取笔参数(int 笔号, _笔参数_ info_笔参数)
        {
        ...
        /// </summary>
        public virtual _Err_jczMarkEzd2_ 设置笔参数(int 笔号,_笔参数_ info_笔参数)
        {
            info_笔参数.笔号 = 笔号;
