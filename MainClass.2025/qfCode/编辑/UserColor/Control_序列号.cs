...
namespace qfCode
{
    public partial class Control_序列号 : Sunny.UI.UITitlePanel
    {
        type_编辑._编辑类型_ _type;
        _元素_.文本 _cfg;
        public Control_序列号(type_编辑._编辑类型_ type, _元素_.文本 cfg)
        {
            InitializeComponent();
            this._type = type;
