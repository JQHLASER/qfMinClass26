...
namespace qfmain
{
    ...
    public class SqlSugarClient<T> where T : class, new()
    {
        SqlSugar_DB Db = null;
        public SqlSugarClient(SqlSugar_DB Db_)
        {
            this.Db = Db_;
        }
        ...
        {
            var list = this.Db.Db.Queryable<T>().ToList();
            return list;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public bool GetList(out List<T> list, out string msgErr)
        {
            ...
            {
                //开启事务
                this.Db.Db.BeginTran();
                list = this.Db.Db.Queryable<T>().ToList();
                //提交事务
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
            {
                //事务回滚
                this.Db.Db.RollbackTran();
                msgErr = ex.Message;
                rt = false;
            }
        ...
        {
            var list = this.Db.Db.Queryable<T>().Where(exp).ToList();
            return list;
        }
        ...
        {
            return this.Db.Db.Queryable<T>().InSingle(pkid);
        }
        ...
        /// <returns></returns>
        public bool GetObj(int pkid, ref T t_, out string msgErr)
        {
            ...
            try
            {
                //开启事务
                this.Db.Db.BeginTran();
                t_ = this.Db.Db.Queryable<T>().InSingle(pkid);
                //提交事务
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
        ...
        {
            List<T> list = this.Db.Db.SqlQueryable<T>(sqlstr).ToPageList(pageIndex, pageSize);
        ...
        /// <param name="msgErr"></param>
        /// <returns></returns>
        public bool GetList(string sqlstr, int pageIndex, int pageSize, out int totle, out List<T> list, out string msgErr)
        {
            ...
            try
            {
                //开启事务
                this.Db.Db.BeginTran();
                list = this.Db.Db.SqlQueryable<T>(sqlstr).ToPageList(pageIndex, pageSize);
                //提交事务
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
        ...
        {
            List<T> list = this.Db.Db.SqlQueryable<T>(sqlstr).ToList();
            return list;
        }
        ...
        public bool GetList(string sqlstr, out List<T> list, out string msgErr)
        {
            ...
            try
            {
                //开启事务 
                this.Db.Db.BeginTran();
                list = this.Db.Db.SqlQueryable<T>(sqlstr).ToList();
                //提交事务
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
        ...
        public bool GetList(List<int> lst主键内容, string 表名, string 主键字段名, out List<T> list, out string msgErr)
        {
            ...
            sql += ")";
            return GetList(sql, out list, out msgErr);
        }

        public bool GetList(List<string> lst主键内容, string 表名, string 主键字段名, out List<T> list, out string msgErr)
        {
            string sql = $"select * from {表名} where {主键字段名} in ( ";
        ...
        public int Insertable(T insertObj, out string msgErr)
        {
            ...
            try
            {
                //开启事务
                this.Db.Db.BeginTran();
                res = this.Db.Db.Insertable(insertObj).ExecuteCommand();
                //提交事务
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
        ...
        public int Insertable(List<T> listObj, out string msgErr)
        {
            ...
            try
            {
                //开启事务
                this.Db.Db.BeginTran();
                res = this.Db.Db.Insertable(listObj).ExecuteCommand();
                //提交事务
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
        ...
        public bool Insertable(List<T> listObj, out int 受影响行, out string msgErr)
        {
            ...
            {  //开启事务
                this.Db.Db.BeginTran();
                受影响行 = this.Db.Db.Insertable(listObj).ExecuteCommand();
                //提交事务
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
        ...
        public bool Storageable(List<T> StorageableObj, out int 受影响行, out string msgErr)
        {
            ...
            {   //开启事务
                this.Db.Db.BeginTran();
                受影响行 = this.Db.Db.Storageable(StorageableObj).ExecuteCommand();
                //提交事务
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
        ...
        {
            return this.Db.Db.Updateable<T>(obj).ExecuteCommand();
        }
        ...
        public bool Update(T obj, out int 受影响行, out string msgErr)
        {
            ...
            {
                this.Db.Db.BeginTran();
                受影响行 = this.Db.Db.Updateable<T>(obj).ExecuteCommand();
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
            {
        ...
        public int Update(T obj, List<IgnoreColumn> columns)
        {
            if (columns.Count > 0)
            {
                columns.ForEach((e) =>
                {
                    this.Db.Db.IgnoreColumns.Add(e);
                });
            }
            return this.Db.Db.Updateable<T>(obj).ExecuteCommand();
        }
        ...
        {
            return this.Db.Db.Storageable(StorageableObj).ExecuteCommand();
        }
        ...
        public int Storageable(List<T> StorageableObj)
        {
            ...
            try
            {
                //开启事务
                this.Db.Db.BeginTran();
                res = this.Db.Db.Storageable(StorageableObj).ExecuteCommand();
                //提交事务
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
        ...
        {
            return this.Db.Db.Deleteable<T>(obj).ExecuteCommand();
        }
        /// <summary>
        /// 批量删除多条,事务处理
        /// </summary>
        ...
        public bool Delete(List<T> obj, out int 受影响行, out string msgErr)
        {
            ...
            {
                this.Db.Db.BeginTran();
                受影响行 = this.Db.Db.Deleteable<T>(obj).ExecuteCommand();
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
            {
        ...
        {
            return this.Db.Db.Deleteable<T>().Where(exp).ExecuteCommand();
        ...
        /// </summary>
        /// <param name="sqlStr"></param>
        public bool SQL_语句(string sqlStr, out DataTable dt, out string msgErr)
        {
            msgErr = string.Empty;
            dt = new DataTable();
            bool rt = true;
        ...
        {
            DataTable dt = this.Db.Db.SqlQueryable<T>(sqlStr).ToDataTable();
            return dt;
        }
        ...
        {
            return this.Db.Db.SqlQueryable<T>(sqlStr).ToList();
        }
        ...
        /// </summary>
        /// <param name="sqlStr"></param>
        public bool GetList_sql语句(string sqlStr, out List<T> list, out string msgErr)
        {
            msgErr = string.Empty;
            bool rt = true;
            list = new List<T>();
        ...
        /// <param name="msgErr"></param>
        /// <returns></returns>
        public bool 执行(string sql语句, out DataTable row, out string msgErr)
        {
            #region 例
            ...
            try
            {
                ...
                this.Db.Db.BeginTran();
                // 执行原生 SQL 查询
                row = this.Db.Db.SqlQueryable<T>(sql语句).ToDataTable();
                this.Db.Db.CommitTran();
        ...
        public bool 执行(string sql语句, out int 受影响行, out string msgErr)
        {
            ...
            try
            {
                ...
                this.Db.Db.BeginTran();
                // 执行原生 SQL 查询
                受影响行 = this.Db.Db.Ado.ExecuteCommand(sql语句);
                this.Db.Db.CommitTran();
        ...
        public bool 执行(string sql语句, out string msgErr)
        {
            ...
            try
            {
                ...
                this.Db.Db.BeginTran();
                var result = Db.Db.Ado.SqlQuery<string[]>(sql语句);
                this.Db.Db.CommitTran();
        ...
        /// <param name="时间"></param>
        /// <returns></returns>
        public string 时间处理(DateTime 时间)
        {
            switch (this.Db.参数.数据库类型)
            {
                case SqlSugar_DB.enum数据库类型.Sqlite:
                    return $"'{时间.ToString($"yyyy-MM-dd HH:mm:ss")}'";
                case SqlSugar_DB.enum数据库类型.SqlServer:
                    return $"  CONVERT(datetime,'{时间}')";
                case SqlSugar_DB.enum数据库类型.MySql:
        ...
        {
            long totalCount = Db.Db.Ado.GetLong(Sql语句);
            return totalCount;
        }
        ...
        /// <param name="msgErr"></param>
        /// <returns></returns>
        public bool 获取总行数(string Sql语句, out long totalCount, out string msgErr)
        {
            msgErr = string.Empty;
            bool rt = true;
            totalCount = 0;
            ...
            {
                this.Db.Db.BeginTran();
                totalCount = Db.Db.Ado.GetLong(Sql语句);
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
            {
        ...
        /// <param name="msgErr"></param>
        /// <returns></returns>
        public bool 获取总行数1(string 表名, out long totalCount, out string msgErr)
        {
            msgErr = string.Empty;
            bool rt = true;
            totalCount = 0;
            ...
            {
                this.Db.Db.BeginTran();
                totalCount = Db.Db.Ado.GetLong($"SELECT COUNT(*) FROM {表名}");
                this.Db.Db.CommitTran();
            }
            catch (Exception ex)
            {
