   ...
   class xml_m
    {
        ...
        public class XmlHelper : IDisposable
        {
            ...
            public static DataSet 读取XML到DataSet(string XmlPath)
            {
             ...
             ************************************************/
                /**//// <summary>
                    ...
                    /// <returns></returns>
            public static string 读取xml并返回一个一级节点(string XmlPath, string Node)
            {
             ...
             ************************************************/
                /**//// <summary>
                    ...
                    /// <returns></returns>
            public static DataSet 查找数据并返回一个DataSet(string xmlPath, string XmlPathNode)
            {
            ...
            public static void 更新Xml节点内容(string xmlPath, string Node, string Content)
            {
                XmlDocument objXmlDoc = new XmlDocument();
                objXmlDoc.Load(xmlPath);
            ...
            public static void 删除XML节点和此节点下的子节点(string xmlPath, string Node)
            {
                XmlDocument objXmlDoc = new XmlDocument();
                objXmlDoc.Load(xmlPath);
            ...
            public static void 插入一个节点和此节点的子节点(string xmlPath, string MailNode, string ChildNode, string Element, string Content)
            {
                XmlDocument objXmlDoc = new XmlDocument();
                objXmlDoc.Load(xmlPath);
            ...
            public static void 插入一节点并带一属性(string xmlPath, string MainNode, string Element, string Attrib, string AttribContent, string Content)
            {
                XmlDocument objXmlDoc = new XmlDocument();
                objXmlDoc.Load(xmlPath);
             ...
             *     </test>
             ************************************************/
            public static void 插入一节点不带属性(string xmlPath, string MainNode, string Element, string Content)
            {
                XmlDocument objXmlDoc = new XmlDocument();
                objXmlDoc.Load(xmlPath);
                XmlNode objNode = objXmlDoc.SelectSingleNode(MainNode);
