...
namespace qfmain
{
    public class 软件类
    {
        ...
        public class Files_Cfg
        {
            ...
            /// 程序参数
            /// </summary>
            public static string Files_Config { set; get; } = $"{Files_ConfigMyApp}\\Config";
            /// <summary>
            /// 图片
            /// </summary>
            public static string Files_Image { set; get; } = $"{Files_ConfigMyApp}\\Image";

            /// <summary>
            /// 商标
            /// </summary>
            public static string Files_res { set; get; } = $"{Files_ConfigMyApp}\\res";
            /// <summary>
            /// 系统参数
            /// </summary>
            public static string Files_sysConfig { set; get; } = $"{Files_ConfigMyApp}\\sysConfig";

            /// <summary>
            /// 语言
            /// </summary>
            public static string Files_Langeuage { set; get; } = $"{Files_ConfigMyApp}\\Langeuage";

            /// <summary>
            /// 帮助
            /// </summary>
            public static string Files_help { set; get; } = $"{Files_ConfigMyApp}\\help";
        }
