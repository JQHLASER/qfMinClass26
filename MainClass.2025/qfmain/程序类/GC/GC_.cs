...
namespace qfmain
{
    ...
    public class GC_
    {
        ...
        /// <summary>
        /// sleepSpan : WPFHelper 时有效
        /// </summary> >
        public GC_(_em_方法_ 方法 = _em_方法_.WPFHelper, int sleepSpan = 30)
        {
            switch (方法)
            {
                case _em_方法_.WPFHelper:
                    //自动GC
                    LierdaCracker cracker = new LierdaCracker();
                    cracker.Cracker(sleepSpan); break;
                case _em_方法_.Windows:
                    new GC_Windows专用().Start(); break;
            }
