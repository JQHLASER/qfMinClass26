...
namespace qfmain
{
    internal class ini_win_多个
    {
        ...
        public string[] 读取_所有节点名称(string iniFile)
        {
        ...
        public string[] 获取_指定节点的所有值(string iniFile, string section)
        {
        ...
        public string[] 获取_指定节点所有条目的Key列表(string iniFile, string section)
        {
        ...
        public string 获取_指定KEY的值(string iniFile, string section, string key, string defaultValue)
        {
        ...
        /// <returns></returns>
        public bool 写入(string iniFile, string section, string items)
        {
            if (string.IsNullOrEmpty(section))
            {
                throw new ArgumentException("必须指定节点名称", "section");
        ...
        /// <returns>操作是否成功</returns>
        public bool 写入(string iniFile, string section, string key, string value)
        {
            if (string.IsNullOrEmpty(section))
            {
                throw new ArgumentException("必须指定节点名称", "section");
        ...
        /// <param name="key">键</param>
        /// <returns>操作是否成功</returns>
        public bool 删除_指定节点及KEY(string iniFile, string section, string key)
        {
            if (string.IsNullOrEmpty(section))
            {
                throw new ArgumentException("必须指定节点名称", "section");
        ...
        /// <param name="section">节点</param>
        /// <returns>操作是否成功</returns>
        public bool 删除_指定的节点(string iniFile, string section)
        {
            if (string.IsNullOrEmpty(section))
            {
                throw new ArgumentException("必须指定节点名称", "section");
        ...
        /// <param name="section">节点</param>
        /// <returns>操作是否成功</returns>
        public bool 删除_指定的节点中所有的内容(string iniFile, string section)
        {
            if (string.IsNullOrEmpty(section))
            {
                throw new ArgumentException("必须指定节点名称", "section");
