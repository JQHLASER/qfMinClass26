...
namespace qfmain
{
    public  class Excel_
    {
        ...
        /// <returns></returns>
        public bool 数据导出到excel(DataTable Table, string ExcelFilePath)
        {
        ...
        /// <param name="ExcelFilePath">Excel文件路径</param>
        public bool 将数据导出至Excel文件2(DataTable Table, ArrayList Columns, string ExcelFilePath)
        {
            if (File.Exists(ExcelFilePath))
            {
                Console.WriteLine("该文件已经存在！");
        ...
        /// 获取Excel文件数据表列表
        /// </summary>
        public ArrayList 获取Excel文件数据表列表(string ExcelFileName)
        {
        ...
        public DataTable 将Excel文件导出至DataTable_第一行作为表头(string ExcelFilePath, string TableName)
        {
            if (!File.Exists(ExcelFilePath))
            {
            ...
            TableList = 获取Excel文件数据表列表(ExcelFilePath);
        ...
        public ArrayList 获取Excel文件指定数据表的数据列表(string ExcelFileName, string TableName)
        {
            DataTable dt = new DataTable();
