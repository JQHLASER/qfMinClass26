...
namespace qfWork
{
    ...
    public class _BM_功能_文本_
    {
        public bool 外部文本 { set; get; } = false;
    }
    public class _BM_功能_序列号_
    {
    ...
    public class _BM_功能_
    {
     
        public _BM_功能_工具_ 工具箱 { set; get; } = new _BM_功能_工具_();
        public _BM_功能_文件_ 文件类 { set; get; } = new _BM_功能_文件_();
        public _BM_功能_对象属性_ 对象属性 { set; get; } = new _BM_功能_对象属性_();
        public _BM_文本_ 文本 { set; get; } = new _BM_文本_();
        public _BM_功能_序列号_ 序列号 { set; get; } = new _BM_功能_序列号_();
        public _BM_功能_日期时间_ 日期时间 { set; get; } = new _BM_功能_日期时间_();

        /// <summary>
        /// 定制的功能
        /// </summary>
        public _BM_功能_定制_ 定制 { set; get; } = new _BM_功能_定制_();
        ...
        /// 文件保存方式
        /// </summary>
        public _BM_文件类型_ _文件类型 { set; get; } = _BM_文件类型_.ini;
    }
}
