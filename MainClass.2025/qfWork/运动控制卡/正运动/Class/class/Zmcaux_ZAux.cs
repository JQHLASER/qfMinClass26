...
namespace qfWork
{
    internal class zmcaux_ZAux_正运动
    {
        ...
        public static extern Int32 在线命令_Execute(IntPtr 连接句柄, string 字符串命令, StringBuilder 返回的字符串, UInt32 反回的字符串长度);
        ...
        public static extern Int32 在线命令_DirectCommand(IntPtr 连接句柄, string 命令字符串, StringBuilder 返回的字符串, UInt32 返回的字符串长度);
        ...
        public static extern Int32 命令跟踪设置(int 命令获取类型, string 文件路径);
        ...
        public static extern Int32 串口链接(UInt32 串口号, out IntPtr 句柄指针);
        ...
        public static extern Int32 搜索串口连接控制器(UInt32 最小串口号, UInt32 最大串口号, ref uint 有效的串口列表, UInt32 连接时间, out IntPtr 句柄指针);
        ...
        public static extern Int32 设置COM口连接参数(UInt32 波特率, UInt32 数据位, UInt32 校验位, UInt32 停止位);
        ...
        public static extern Int32 设置IP地址(IntPtr 连接句柄, string IP地址);
        ...
        public static extern Int32 以太网方式连接(string IP地址, out IntPtr 连接句柄);
        ...
        public static extern Int32 快速搜索IP地址(StringBuilder IP地址列表指针, UInt32 搜索IP地址最大长度, UInt32 搜索最大时间);
        ...
        public static extern Int32 搜索控制器(string IP地址, UInt32 最大搜索时间);
        ...
        public static extern Int32 关闭控制器链接(IntPtr 连接句柄);
        ...
        public static extern Int32 暂停继续运行BAS项目(IntPtr 连接句柄);
        ...
        public static extern Int32 暂停控制器中BAS程序(IntPtr 连接句柄);
        ...
        public static extern Int32 ZAR下载到控制器运行_单个BAS文件(IntPtr 连接句柄, string BAS文件路径, UInt32 run_mode);
        ...
        public static extern Int32 输入信号_读取(IntPtr 连接句柄, int 输入口编号, ref UInt32 输入口状态);
        ...
        public static extern Int32 输出信号_设置(IntPtr 连接句柄, int 输出口编号, UInt32 输出口状态值);
        ...
        public static extern Int32 输出信号_读取(IntPtr 连接句柄, int 输出口编号, ref UInt32 输出口状态值);
        ...
        public static extern Int32 模拟量_输入值读取(IntPtr 连接句柄, int 模拟量输入编号, ref float 模拟量值);
        ...
        public static extern Int32 模拟量_输出设置(IntPtr 连接句柄, int 模拟量输出编号, float 模拟量值);
        ...
        public static extern Int32 模拟量_输出值读取(IntPtr 连接句柄, int 模拟量输出编号, ref float 模拟量值);
        ...
        public static extern Int32 输入信号_反转状态设置(IntPtr 连接句柄, int 输入口编号, int 反转状态设置值);
        ...
        public static extern Int32 输入信号_反转状态读取(IntPtr 连接句柄, int 输入口编号, ref int 反转状态返回值);
        ...
        public static extern Int32 pwm_频率设置(IntPtr 连接句柄, int PWM编号口, float 频率值设定值);
        ...
        public static extern Int32 pwm_频率读取(IntPtr 连接句柄, int PWM编号口, ref float 频率返回值);
        ...
        public static extern Int32 pwm_设置pwm占空比(IntPtr 连接句柄, int PWM编号口, float 占空比设置值);
        ...
        public static extern Int32 pwm_读取pwm占空比(IntPtr 连接句柄, int PWM编号口, ref float 占空比反馈值);

        /// <summary>
        /// 快速读取多个输入状态 ,申明 byte[] B =new byte[8]
        /// </summary>
        /// <param name="handle">连接句柄</param>
        ...
        public static extern Int32 输入信号_快速读取多个输入状态(IntPtr 连接句柄, int 输入口起始编号, int 输入口结束编号, byte[] 状态返回值);

        /// <summary>
        /// 快速读取多个输出口状态 ,申明 byte[] B =new byte[8] ,使用时为B[0],B[1]等
        /// </summary>
        /// <param name="handle">连接句柄</param>
        ...
        public static extern Int32 输出信号_快速读取多个输出口状态(IntPtr 连接句柄, int 输出口起始编号, int 输出口结束编号, byte[] 状态返回值);
        ...
        public static extern Int32 轴__快速读取多个轴的命令位置(IntPtr 连接句柄, int 轴数量, float[] 命令位置反馈值);
        ...
        public static extern Int32 轴__快速读取多个轴的反馈位置(IntPtr 连接句柄, int 轴数量, float[] 反馈位置反馈值);
        ...
        public static extern Int32 轴__快速读取多个轴的规划运行速度(IntPtr 连接句柄, int 轴数量, float[] 规划速度反馈值);
        ...
        public static extern Int32 轴__设置通用的轴参数(IntPtr 连接句柄, string 轴参数名称字符串, int 轴号, float 设定值);
        ...
        public static extern Int32 轴__读取通用的参数(IntPtr 连接句柄, string 轴参数名称字符串, int 轴号, ref float 反馈值);
        ...
        public static extern Int32 轴_设置轴加速度(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴加速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取叠加轴轴号(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴急停报警信号输入口(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴急停报警信号输入口(IntPtr handle, int iaxis, ref int piValue);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="iValue">轴类型设置值,一般为1:脉冲方式步进或伺服</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetAtype", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 轴_设置轴类型_Atype(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴类型_Atype(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_读取轴状态_AxisStatus(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_读取轴地址(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴使能(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴使能状态(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置同步运动链接速率(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取同步运动链接速率(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置锁存触发的结束坐标范围点(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取锁存触发的结束坐标范围点(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置拐角减速模式(IntPtr handle, int iaxis, int pfValue);
        ...
        public static extern Int32 轴_读取拐角减速模式(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置回零爬行速度(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取回零爬行速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴原点硬限位输入口(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴原点硬限位输入口(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴减速度(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴减速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置拐角减速起始减速角度(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取拐角减速起始减速角度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置虚拟坐标位置_轴命令位置坐标(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取虚拟坐标位置_轴命令位置坐标(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取轴内部编码器值(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取轴坐标_当前运动的最终位置(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取当前和缓冲中运动的最终位置_可以用于相对绝对转换(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置SP运动的结束速度(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取SP运动的结束速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置错误标记和AXISSTATUS做与运算来决定哪些错误需要关闭WDOG(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取错误标记和AXISSTATUS做与运算来决定哪些错误需要关闭WDOG(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置快速JOG输入口编号(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取快速JOG输入口编号(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴异常快速减速度(IntPtr handle, int iaxis, float iValue);
        ...
        public static extern Int32 轴_读取轴异常快速减速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取轴随动误差(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴最大允许的随动误差值(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴最大允许的随动误差值(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴报警时随动误差值(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴报警时的随动误差值(IntPtr handle, int iaxis, ref float fValue);
        ...
        public static extern Int32 轴_设置轴保持输入口(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴保持输入口编号(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴保持速度(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴保持速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴SP运动的运行速度(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴SP运动的运行速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴正向软限位(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴正向软限位(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴小圆限速最小半径(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴小圆限速最小半径(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴正向硬限位输入口(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴正向硬限位输入口编号(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴正向JOG输入口(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴正向JOG输入口编号(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_读取轴运动状态(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴脉冲输出模式(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴脉冲输出模式(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴插补运动时是否参与速度计算(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴插补运动时是否参与速度计算(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴JOG运动时速度(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴JOG运动时速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取轴链接运动的参考轴号(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_读取轴当前除了当前运动是否还有缓冲运动(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴起始速度(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴起始速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴回零反找等待时间(IntPtr handle, int iaxis, int fValue);
        ...
        public static extern Int32 轴_读取轴回零反找等待时间(IntPtr handle, int iaxis, ref int pfValue);
        ...
        public static extern Int32 轴_读取编码轴锁存触发mark状态(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_读取编码轴锁存触发markB状态(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴脉冲输出最高频率(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴脉冲输出最高频率(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴连续插补模式(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴连续插补模式(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_读取轴当前被缓冲起来的运动个数(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_读取轴当前正在运动指令的MOVE_MARK标号(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴运动MOVE_MARK标号(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_设置编码轴反馈位置坐标(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取编码轴反馈位置坐标_实时坐标(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取编码轴反馈速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取轴当前运动指令类型(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_读取轴正在运动指令后面的第一条指令类型(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴坐标偏移(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴坐标偏移(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置编码轴锁存触发的结束坐标范围点(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取编码轴锁存触发的结束坐标范围点(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取编码轴锁存MAKR触发的反馈位置坐标(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取编码轴锁存MAKRB触发的反馈位置坐标(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取轴当前运动还未完成的距离(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取轴剩余的直线缓冲(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_读取轴剩余运动缓冲_按最复杂的空间圆弧来计算(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴坐标循环范围值(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴坐标循环范围值(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴坐标循环模式(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴坐标循环模式(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴负向硬限位输入口(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴负向硬限位输入口(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴负向JOG输入对应的输入点编号(IntPtr handle, int iaxis, int iValue);
        ...
        public static extern Int32 轴_读取轴负向JOG输入对应的输入点编号(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置轴负向软限位坐标(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴负向软限位坐标(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴速度(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴S曲线加减速(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴S曲线加减速(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴SP运动的起始速度(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴SP运动的起始速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴拐角减速_停止减速角度(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴拐角减速_停止减速角度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴拐角减速_倒角半径(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴拐角减速_倒角半径(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_设置轴脉冲当量(IntPtr handle, int iaxis, float fValue);
        ...
        public static extern Int32 轴_读取轴脉冲当量(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取轴当前运动和缓冲运动还未完成的距离(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_读取轴当前运行的规划速度(IntPtr handle, int iaxis, ref float pfValue);
        ...
        public static extern Int32 轴_全局变量_参数浮点类型读取命令(IntPtr handle, string pname, ref float pfValue);
        ...
        public static extern Int32 轴_全局变量_参数整数类型读取命令(IntPtr handle, string pname, ref int piValue);
        ...
        public static extern Int32 轴_选定运动轴列_BASE的一个轴作为插补主轴(IntPtr handle, int imaxaxises, int[] piAxislist);
        ...
        public static extern Int32 轴_多轴相对直线插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float[] pfDposlist);
        ...
        public static extern Int32 轴_多轴相对直线插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float[] pfDposlist);
        ...
        public static extern Int32 轴_多轴绝对直线插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float[] pfDposlist);
        ...
        public static extern Int32 轴_多轴绝对直线插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float[] pfDposlist);
        ...
        public static extern Int32 轴_运动中修改结束位置_单轴指令(IntPtr handle, int iaxis, float pfDisance);
        ...
        public static extern Int32 轴_相对圆心定圆弧插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection);
        ...
        public static extern Int32 轴_相对圆心定圆弧插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection);
        ...
        public static extern Int32 轴_绝对圆心圆弧插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection);
        ...
        public static extern Int32 轴_绝对圆心圆弧插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection);
        ...
        public static extern Int32 轴_相对3点定圆弧插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fmid1, float fmid2, float fend1, float fend2);
        ...
        public static extern Int32 轴_相对3点定圆弧插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fmid1, float fmid2, float fend1, float fend2);
        ...
        public static extern Int32 轴_绝对3点定圆弧插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fmid1, float fmid2, float fend1, float fend2);
        ...
        public static extern Int32 轴_相对3轴圆心螺旋插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection, float fDistance3, int imode);
        ...
        public static extern Int32 轴_绝对3轴圆心螺旋插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection, float fDistance3, int imode);
        ...
        public static extern Int32 轴_相对3轴圆心螺旋插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection, float fDistance3, int imode);
        ...
        public static extern Int32 轴_绝对3轴圆心螺旋插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection, float fDistance3, int imode);
        ...
        public static extern Int32 轴_相对3轴_3点定螺旋插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fmid1, float fmid2, float fend1, float fend2, float fDistance3, int imode);
        ...
        public static extern Int32 轴_绝对3轴_3点定螺旋插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fmid1, float fmid2, float fend1, float fend2, float fDistance3, int imode);
        ...
        public static extern Int32 轴_相对3轴_3点定螺旋插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fmid1, float fmid2, float fend1, float fend2, float fDistance3, int imode);
        ...
        public static extern Int32 轴_绝对3轴_3点定螺旋插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fmid1, float fmid2, float fend1, float fend2, float fDistance3, int imode);
        ...
        public static extern Int32 轴_相对椭圆插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection, float fADis, float fBDis);
        ...
        public static extern Int32 轴_绝对椭圆插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection, float fADis, float fBDis);
        ...
        public static extern Int32 轴_相对椭圆插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection, float fADis, float fBDis);
        ...
        public static extern Int32 轴_绝对椭圆插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection, float fADis, float fBDis);
        ...
        public static extern Int32 轴_相对_椭圆and螺旋插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection, float fADis, float fBDis, float fDistance3);
        ...
        public static extern Int32 轴_绝对椭圆and螺旋插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection, float fADis, float fBDis, float fDistance3);
        ...
        public static extern Int32 轴_相对_椭圆and螺旋插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection, float fADis, float fBDis, float fDistance3);
        ...
        public static extern Int32 轴_绝对椭圆and螺旋插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fcenter1, float fcenter2, int idirection, float fADis, float fBDis, float fDistance3);
        ...
        public static extern Int32 轴_空间圆弧and螺旋插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fend3, float fcenter1, float fcenter2, float fcenter3, int imode, float fcenter4, float fcenter5);
        ...
        public static extern Int32 轴_空间圆弧and螺旋插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float fend1, float fend2, float fend3, float fcenter1, float fcenter2, float fcenter3, int imode, float fcenter4, float fcenter5);
        ...
        public static extern Int32 轴_相对渐开线圆弧插补运动(IntPtr handle, int imaxaxises, int[] piAxislist, float centre1, float centre2, float circles, float pitch, float distance3, float distance4);
        ...
        public static extern Int32 轴_相对渐开线圆弧插补SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float centre1, float centre2, float circles, float pitch, float distance3, float distance4);
        ...
        public static extern Int32 轴_空间直线运动(IntPtr handle, int imaxaxises, int[] piAxislist, float end1, float end2, float end3, float next1, float next2, float next3, float radius);
        ...
        public static extern Int32 轴_空间直线SP运动(IntPtr handle, int imaxaxises, int[] piAxislist, float end1, float end2, float end3, float next1, float next2, float next3, float radius);
        ...
        public static extern Int32 轴_运动暂停(IntPtr handle, int iaxis, int imode);
        ...
        public static extern Int32 轴_恢复暂停运动(IntPtr handle, int iaxis);
        ...
        public static extern Int32 轴_运动末尾位置增加速度限制(IntPtr handle, int iaxis, float limitspeed);
        ...
        public static extern Int32 轴_运动缓冲中插入输出指令(IntPtr handle, int iaxis, int ioutnum, int ivalue);
        ...
        public static extern Int32 轴_运动缓冲中插入连续输出口指令(IntPtr handle, int iaxis, int ioutnumfirst, int ioutnumend, int ivalue);
        ...
        public static extern Int32 轴_运动缓冲中插入输出脉冲波指令(IntPtr handle, int iaxis, int ioutnum, int ivalue, int iofftimems);
        ...
        public static extern Int32 轴_运动缓冲中插入模拟量输出指令(IntPtr handle, int iaxis, int ioutnum, float fvalue);
        ...
        public static extern Int32 轴_运动缓冲中插入延时指令(IntPtr handle, int iaxis, int itimems);
        ...
        public static extern Int32 轴_旋转台直线插补运动(IntPtr handle, int tablenum, int imaxaxises, int[] piAxislist, float[] pfDisancelist);
        ...
        public static extern Int32 轴_旋转台圆弧and螺插补运动(IntPtr handle, int tablenum, float refpos1, float refpos2, int mode, float end1, float end2, int imaxaxises, int[] piAxislist, float[] pfDisancelist);
        ...
        public static extern Int32 轴_电子凸轮_同步运动_cam(IntPtr handle, int iaxis, int istartpoint, int iendpoint, float ftablemulti, float fDistance);
        ...
        public static extern Int32 轴_电子凸轮_同步运动_cambox(IntPtr handle, int iaxis, int istartpoint, int iendpoint, float ftablemulti, float fDistance, int ilinkaxis, int ioption, float flinkstartpos);
        ...
        public static extern Int32 轴_飞剪追剪MOVELINK_同步运动(IntPtr handle, int iaxis, float fDistance, float fLinkDis, float fLinkAcc, float fLinkDec, int iLinkaxis, int ioption, float flinkstartpos);
        ...
        public static extern Int32 轴_飞剪追剪MOVESLINK_同步运动(IntPtr handle, int iaxis, float fDistance, float fLinkDis, float startsp, float endsp, int iLinkaxis, int ioption, float flinkstartpos);
        ...
        public static extern Int32 轴_电子齿轮_同步运动(IntPtr handle, float ratio, int link_axis, int move_axis);
        ...
        public static extern Int32 轴_电子齿轮矢量同步_同步运动(IntPtr handle, float ratio, int link_axis, int move_axis);
        ...
        public static extern Int32 轴_位置锁存指令(IntPtr handle, int iaxis, int imode);
        ...
        public static extern Int32 轴_设置编码轴输出齿轮比(IntPtr handle, int iaxis, int mpos_count, int input_count);
        ...
        public static extern Int32 轴_设置脉冲输出齿轮比(IntPtr handle, int iaxis, int mpos_count, int input_count);
        ...
        public static extern Int32 轴_急停_停止所有轴运动(IntPtr handle, int imode);
        ...
        public static extern Int32 轴__急停多轴运动停止(IntPtr handle, int imaxaxises, int[] piAxislist, int imode);
        ...
        public static extern Int32 机械手逆解映射指令(IntPtr handle, int Jogmaxaxises, int[] JogAxislist, int frame, int tablenum, int Virmaxaxises, int[] VirAxislist);
        ...
        public static extern Int32 机械手正解映射指令(IntPtr handle, int Virmaxaxises, int[] VirAxislist, int frame, int tablenum, int Jogmaxaxises, int[] JogAxislist);
        ...
        public static extern Int32 轴_轴叠加运动指令(IntPtr handle, int iaxis, int iaddaxis);
        ...
        public static extern Int32 轴_单轴运动停止(IntPtr handle, int iaxis, int imode);
        ...
        public static extern Int32 轴_单轴连续运动(IntPtr handle, int iaxis, int idir);
        ...
        public static extern Int32 轴_单轴回零_Datum(IntPtr handle, int iaxis, int imode);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="imode">回零模式,一般为3</param>
        /// <returns>错误码</returns>
        ...
        public static extern Int32 轴_读取单轴回零状态_GetHomeStatus(IntPtr handle, int iaxis, ref UInt32 homestatus);
        ...
        public static extern Int32 轴_单轴相对运动(IntPtr handle, int iaxis, float fdistance);
        ...
        public static extern Int32 轴_单轴绝对运动(IntPtr handle, int iaxis, float fdistance);
        ...
        public static extern Int32 VR_float寄存器_设置(IntPtr 连接句柄, int VR起始编号, int 写入的数量, float[] 写入的数据列表);
        ...
        public static extern Int32 VR_float寄存器_读取(IntPtr 连接句柄, int VR起始地址, int 读取的数量, float[] VR反馈值数据);
        ...
        public static extern Int32 VR_INT寄存器_读取(IntPtr 连接句柄, int VR起始地址, int 读取的数量, int[] VRINT反馈值);
        ...
        public static extern Int32 VR_INT寄存器_设置(IntPtr 连接句柄, int VR起始地址, int 写入的数量, int[] 写入的数据列表);
        ...
        public static extern Int32 Table_设置TABLE寄存器(IntPtr handle, int vrstartnum, int numes, float[] pfValue);
        ...
        public static extern Int32 Table_读取TABLE寄存器(IntPtr handle, int tabstart, int numes, float[] pfValue);
        ...
        public static extern Int32 数据_字符串转为float数据(string pstringin, int inumes, float[] pfValue);
        ...
        public static extern Int32 数据_字符串转为INT数据(string pstringin, int inumes, int[] pfValue);
        ...
        public static extern Int32 文件_把float格式的变量列表存储到文件(string sFilename, float[] pVarlist, int inum);
        ...
        public static extern Int32 数据_读取float格式的变量列表(string sFilename, float[] pVarlist, ref int inum);
        ...
        public static extern Int32 Modbus_设置MODBUS_BIT位寄存器(IntPtr handle, UInt16 start, UInt16 inum, byte[] pdata);
        ...
        public static extern Int32 Modbus_读取MOBUS_BIT位寄存器(IntPtr handle, UInt16 start, UInt16 inum, byte[] pdata);
        ...
        public static extern Int32 Modbus_设置MODBUS_REG字寄存器(IntPtr handle, UInt16 start, UInt16 inum, UInt16[] pfdata);
        ...
        public static extern Int32 Modbus_读取MODBUS_REG字寄存器(IntPtr handle, UInt16 start, UInt16 inum, UInt16[] pfdata);
        ...
        public static extern Int32 Modbus_读取MODBUS_IEEE寄存器_float(IntPtr handle, UInt16 start, UInt16 inum, float[] pfdata);
        ...
        public static extern Int32 Modbus_设置MODBUS_IEEE寄存器_float(IntPtr handle, UInt16 start, UInt16 inum, float[] pfdata);
        ...
        public static extern Int32 Modbus_读取MODBUS_LONG寄存器(IntPtr handle, UInt16 start, UInt16 inum, Int32[] pfdata);
        ...
        public static extern Int32 Modbus_设置MODBUS_LONG寄存器(IntPtr handle, UInt16 start, UInt16 inum, Int32[] pfdata);
        ...
        public static extern Int32 Modbus_读取MODBUS_STRING寄存器(IntPtr handle, UInt16 start, UInt16 inum, StringBuilder pfdata);
        ...
        public static extern Int32 Modbus_设置MODBUS_STRING寄存器(IntPtr 连接句柄, UInt16 起始编号, UInt16 字节数量, string 设定字符串);
        ...
        public static extern Int32 Flash_写控制器flash块_float格式(IntPtr handle, UInt16 uiflashid, UInt32 uinumes, float[] pfvlue);
        ...
        public static extern Int32 Flash_读取控制器flash块_float格式(IntPtr handle, UInt16 uiflashid, UInt32 uibuffnum, float[] pfvlue, ref UInt32 puinumesread);
        ...
        public static extern Int32 示波器_示波器触发函数_150723以后固件版本支持(IntPtr handle);
        ...
        public static extern Int32 轴_运动缓冲中插入参数修改(IntPtr handle, UInt32 base_axis, string paraname, UInt32 iaxis, float fvalue);
        ...
        public static extern Int32 轴_运动缓冲中插入PWM指令(IntPtr handle, UInt32 base_axis, UInt32 pwm_num, float pwm_duty, float pwm_freq);
        ...
        public static extern Int32 轴_运动缓冲中插入同步其他轴的运动(IntPtr handle, UInt32 base_axis, UInt32 iaxis, float fdist, UInt32 ifsp);
        ...
        public static extern Int32 轴_运动缓冲中插入触发其他轴的运动(IntPtr handle, UInt32 base_axis, UInt32 iaxis, float fdist, UInt32 ifsp);
        ...
        public static extern Int32 轴_运动缓冲中插入修改TABLE寄存器指令(IntPtr handle, UInt32 base_axis, UInt32 table_num, float fvalue);
        ...
        public static extern Int32 轴_运动缓冲中插入等待调节指令(IntPtr handle, UInt32 base_axis, string paraname, int inum, int Cmp_mode, float fvalue);
        ...
        public static extern Int32 ZAux_轴_运动缓冲中插入TASK任务(IntPtr handle, UInt32 base_axis, UInt32 tasknum, string labelname);
        ...
        public static extern Int32 轴_软件位置比较输出(IntPtr handle, int num, int enable, int axisnum, int outnum, int outstate, float setpos, float resetpos);
        ...
        public static extern Int32 轴_硬件位置比较输出_4系列产品脉冲轴与编码器轴支持硬件比较输出(IntPtr handle, int Axisnum, int Mode, int Direction, int Reserve, int Tablestart, int Tableend);
        ...
        public static extern Int32 轴_硬件位置比较输出剩余缓冲获取_4系列产品脉冲轴与编码器轴支持硬件比较输出(IntPtr handle, int axisnum, ref int buff);
        ...
        public static extern Int32 轴_硬件定时器用于硬件比较输出后一段时间后还原电平_4系列产品支持(IntPtr handle, int mode, int cyclonetime, int optime, int reptimes, int opstate, int opnum);
        ...
        public static extern Int32 轴_读取轴停止运动原因(IntPtr handle, int iaxis, ref int piValue);
        ...
        public static extern Int32 轴_读取多轴轴参数(IntPtr handle, string sParam, int imaxaxis, float[] pfValue);
        ...
        public static extern Int32 轴_读取多轴基本参数状态(IntPtr handle, int imaxaxis, int[] IdleStatus, float[] DposStatus, float[] MposStatus, int[] AxisStatus);
        ...
        public static extern Int32 数据_设置BASIC自定义全局数组(IntPtr handle, string arrayname, int arraystart, int numes, float[] pfValue);
        ...
        public static extern Int32 数据_读取BASIC自定义全局数组(IntPtr handle, string arrayname, int arraystart, int numes, float[] pfValue);
        ...
        public static extern Int32 数据_设置BASIC自定义变量(IntPtr handle, string varname, float pfValue);
        ...
        public static extern Int32 数据_读取BASIC自定义变量(IntPtr handle, string varname, ref float pfValue);
        ...
        public static extern Int32 PCI_读取PCI控制卡个数();
        ...
        public static extern Int32 PCI_PCI卡建立链接(UInt32 cardnum, out IntPtr phandle);
        ...
        public static extern Int32 获取控制器卡信息(IntPtr 连接句柄, StringBuilder 控制器型号类型反馈值, StringBuilder 控制器软件版本_固件版本反馈值, StringBuilder 控制器唯一ID反馈值);
        ...
        public static extern Int32 读取总线控制器卡连接节点数量(IntPtr handle, int slot, ref int piValue);
        ...
        public static extern Int32 读取节点上的信息(IntPtr handle, UInt32 slot, UInt32 node, UInt32 sel, ref int piValue);
        ...
        public static extern Int32 读取总线节点通讯状态(IntPtr handle, UInt32 slot, UInt32 node, ref UInt32 nodestatus);
        ...
        public static extern Int32 读取节点SDO参数信息(IntPtr handle, UInt32 slot, UInt32 node, UInt32 index, UInt32 subindex, UInt32 type, ref Int32 value);
        ...
        public static extern Int32 写节点SDO参数信息(IntPtr handle, UInt32 slot, UInt32 node, UInt32 index, UInt32 subindex, UInt32 type, Int32 value);
        ...
        public static extern Int32 轴_读取轴SDO参数信息(IntPtr handle, UInt32 iaxis, UInt32 index, UInt32 subindex, UInt32 type, ref Int32 value);
        ...
        public static extern Int32 轴_写轴SDO参数信息(IntPtr handle, UInt32 iaxis, UInt32 index, UInt32 subindex, UInt32 type, Int32 value);
        ...
        public static extern Int32 轴_读取Rtex驱动器参数(IntPtr handle, UInt32 iaxis, UInt32 ipara, ref float value);
        ...
        public static extern Int32 轴_设置Rtex驱动器参数信息(IntPtr handle, UInt32 iaxis, UInt32 ipara, float value);
        ...
        public static extern Int32 轴_设置回零偏移距离(IntPtr handle, UInt32 iaxis, float fValue);
        ...
        public static extern Int32 轴_读取回零偏移距离(IntPtr handle, UInt32 iaxis, ref float fValue);
        ...
        public static extern Int32 轴_总线驱动器自身回零运动(IntPtr handle, UInt32 iaxis, UInt32 homemode);
        ...
        public static extern Int32 轴_总线驱动器回零完成状态(IntPtr handle, UInt32 iaxis, ref UInt32 homestatus);
        ...
        public static extern Int32 轴_清除总线伺服轴报警(IntPtr handle, UInt32 iaxis, UInt32 mode);
        ...
        public static extern Int32 轴_读取总线轴当前力矩_需要设置对应的DRIVE_PROFILE类型(IntPtr handle, UInt32 iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置总线轴最大转矩_需要设置对应的DRIVE_PROFILE类型(IntPtr handle, UInt32 iaxis, int piValue);
        ...
        public static extern Int32 轴_读取总线轴最大转矩_需要设置对应的DRIVE_PROFILE类型(IntPtr handle, UInt32 iaxis, ref int piValue);
        ...
        public static extern Int32 轴_设置总线轴模拟量输出_总线驱动需要设置对应DRIVE_PROFILE类型_与ATYPE(IntPtr handle, UInt32 iaxis, float fValue);
        ...
        public static extern Int32 轴_读取总线轴模拟量输出_总线驱动需要设置对应DRIVE_PROFILE类型与ATYPE(IntPtr handle, UInt32 iaxis, ref float fValue);
        ...
        public static extern Int32 轴_总线初始化指令(IntPtr handle);
        ...
        public static extern Int32 轴_读取总线初始化状态(IntPtr handle, ref int piValue);
        ...
        public static extern Int32 输入_读取多个输入信号(IntPtr handle, int startio, int endio, Int32[] piValue);
        ...
        public static extern Int32 设置在线命令的超时时间(IntPtr handle, UInt32 timems);
    ...
    *************************************************************/
        ...
        public static extern Int32 轴_硬件位置比较输出2_4系列产品(IntPtr handle, int Axisnum, int Mode, int Opnum, int Opstate, float ModePara1, float ModePara2, float ModePara3, float ModePara4);
        ...
        public static extern Int32 获取控制器最大规格数(IntPtr handle, ref UInt16 Max_VirtuAxises, byte[] Max_motor, byte[] Max_io);
        ...
        public static extern Int32 控制器主动上报回调函数(IntPtr handle, ZAuxCallBack pcallback);
        ...
        public static extern Int32 输出_设置多路输出(IntPtr 连接句柄, UInt16 IO口起始编号, UInt16 IO口结束编号, UInt32[] 输出口状态);
        ...
        public static extern Int32 输出_读取多路输出(IntPtr 连接句柄, UInt16 IO口起始编号, UInt16 IO口结束编号, UInt32[] 输出口状态);
        ...
        public static extern Int32 轴_多轴相对直线插补运动(IntPtr handle, int iMoveLen, int imaxaxises, int[] piAxislist, float[] pfDposlist);
        ...
        public static extern Int32 轴_多轴绝对直线插补运动(IntPtr handle, int iMoveLen, int imaxaxises, int[] piAxislist, float[] pfDposlist);
