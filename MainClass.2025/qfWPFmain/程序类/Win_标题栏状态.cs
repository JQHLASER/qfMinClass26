...
namespace qfWPFmain
{
    public class Win_标题栏状态
    {
        ...
        public void 初始化状态_qfWork(ui_window_Title ui标题栏, string Name, string 名称, qfWork._初始化状态_ 状态)
        {
            qfWPFmain._windowInfo_[] info = new _windowInfo_[]
           {
              new qfWPFmain._windowInfo_(Name,(int)qfWork._初始化状态_ .已初始化 ,$"{名称}{Language_ .Get语言("已初始化")}"  ),
              new qfWPFmain._windowInfo_(Name,(int)qfWork._初始化状态_.未初始化,$"{名称}{Language_ .Get语言("未初始化")}"  ),
              new qfWPFmain._windowInfo_(Name,(int)qfWork._初始化状态_.初始化中 ,$"{名称}{Language_ .Get语言("初始化中")}"  ),
