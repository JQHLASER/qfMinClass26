...
namespace qfNet
{
    public partial class Form_jcz单头_调试 : Sunny.UI.UIForm
    {
       ...
       // protected override CreateParams CreateParams { get { CreateParams cp = base.CreateParams; cp.ExStyle |= 0x02000000; return cp; } }
        ...
        internal Form_jcz单头_调试(qfNet.MarkEzd markEzd_, qfNet.MultilineMarkEzd multilineMarkEzd_ = null, int cardindex = -1)
        {
            InitializeComponent();
        ...
        async Task<bool> Mark_MultiLine()
        {
            ...
            Task t0 = Task.Run(() =>
            {
                this._multilineMarkEzd.On_加工状态(this._Cardindex, qfWork._激光加工状态_.出激光标刻中);
                rt = this._multilineMarkEzd.标刻(this._Cardindex, false, out string msgErr);
                this._multilineMarkEzd.等待_标刻结束(this._Cardindex, 100);
                this._multilineMarkEzd.On_加工状态(this._Cardindex, qfWork._激光加工状态_.闲置);
