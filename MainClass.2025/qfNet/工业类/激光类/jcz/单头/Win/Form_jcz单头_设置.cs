...
namespace qfNet
{
    public partial class Form_jcz单头_设置 : Sunny.UI.UIForm
    {
        ...
        public Form_jcz单头_设置(qfNet.MarkEzd markEzd_, qfNet.MultilineMarkEzd multilineMarkEzd = null, int Cardindex = -1)
        {
            InitializeComponent();
        ...
        void Show()
        {
            ...
            {
                qfNet.MultilineMarkEzd._cfg_参数_ cfg = this._multilineMarkEzd._lst_参数[this._CardIndex];
