...
namespace qfNet
{
    internal partial class Form_SerialPort_Set : Sunny.UI.UIForm
    {
        ...
        internal Form_SerialPort_Set(qfmain.SerialPort_ SerialPort_)
        {
            ...
            this.uiComboBox_串口.DataSource = _串口名称;
            this.uiComboBox_波特率.DataSource = _波特率;
            this.uiComboBox_数据位.DataSource = _数据位;
            this.uiComboBox_停止位.DataSource = this._SerialPort.Get_停止位();
            this.uiComboBox_校验位.DataSource = this._SerialPort.Get_校验位();
            Show();
